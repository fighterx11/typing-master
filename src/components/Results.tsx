  ...
  return (
    <div className="w-full max-w-4xl mx-auto space-y-4 sm:space-y-6 animate-fade-in px-2 sm:px-4">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-6 max-w-2xl mx-auto">
        {/* WPM Card */}
        <Card className="group relative overflow-hidden bg-gradient-to-br from-primary/5 via-card to-primary/10 border border-primary/20 hover:border-primary/40 transition-all duration-300 hover:shadow-strong hover:scale-105 p-4 sm:p-6 text-center">
          ...
          <div className="relative z-10">
            ...
            <div className="text-3xl sm:text-4xl font-bold text-primary mb-1 font-mono">
              {results.wpm}
            </div>
